...
// chimera_x_heep_top : wrapper of the accelerator and x_heep
// Designed by Alessandra Dolmeta, Valeria Piscopo  
// alessandra.dolmeta@polito.it, valeria.piscopo@polito.it
//

module chimera_x_heep_top 
  import obi_pkg::*;
  import reg_pkg::*;
...
#(
  ...
  assign ext_master_req[chimera_x_heep_pkg::EXT_MASTER0_IDX].req = '0;
  assign ext_master_req[chimera_x_heep_pkg::EXT_MASTER0_IDX].we = '0;
  assign ext_master_req[chimera_x_heep_pkg::EXT_MASTER0_IDX].be = '0;
  assign ext_master_req[chimera_x_heep_pkg::EXT_MASTER0_IDX].addr = '0;
  assign ext_master_req[chimera_x_heep_pkg::EXT_MASTER0_IDX].wdata = '0;
  ...
  always_comb begin
    ...
    ext_intr_vector[0] = chimera_intr;
  end

    chimera_wrapper chimera_wrapper_i(
      .clk_i (clk_i),
      .rst_ni(rst_ni),
      // eXtension interface
  ...
  x_heep_system #(
      ...
      .FPU(FPU),
      .ZFINX(ZFINX),
      .EXT_XBAR_NMASTER(chimera_x_heep_pkg::EXT_XBAR_NMASTER)
  ) x_heep_system_i (
      .clk_i,
      .rst_ni,
      .boot_select_i,
  ...
  ext_bus #(
      ...
      .default_idx_i            (chimera_IDX[LOG_EXT_XBAR_NSLAVE-1:0]),
