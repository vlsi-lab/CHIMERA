...
#(
  ...
  assign ram_req_o[12] = int_slave_req[core_v_mini_mcu_pkg::RAM12_IDX];
  assign ram_req_o[13] = int_slave_req[core_v_mini_mcu_pkg::RAM13_IDX];
  assign ram_req_o[14] = int_slave_req[core_v_mini_mcu_pkg::RAM14_IDX];
  assign ram_req_o[15] = int_slave_req[core_v_mini_mcu_pkg::RAM15_IDX];
  ...
  assign int_slave_resp[core_v_mini_mcu_pkg::RAM12_IDX] = ram_resp_i[12];
  assign int_slave_resp[core_v_mini_mcu_pkg::RAM13_IDX] = ram_resp_i[13];
  assign int_slave_resp[core_v_mini_mcu_pkg::RAM14_IDX] = ram_resp_i[14];
  assign int_slave_resp[core_v_mini_mcu_pkg::RAM15_IDX] = ram_resp_i[15];
