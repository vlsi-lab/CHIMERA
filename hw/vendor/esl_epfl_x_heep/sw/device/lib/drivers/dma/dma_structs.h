...
typedef struct {
  ...
  uint32_t SIZE_D1;                               /*!< Number of bytes to copy from, defined with respect to the first dimension - Once a value is written, the copy starts*/

  uint32_t SIZE_D2;                               /*!< Number of bytes to copy from, defined with respect to the second dimension*/
